...
/** Connection between the GaleriaGrupa_Fields type and the MediaItem type */
...
/** Input for the createGaleriaObrazow mutation. */
export type CreateGaleriaObrazowInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createGaleriaObrazow mutation. */
export type CreateGaleriaObrazowPayload = {
  __typename?: 'CreateGaleriaObrazowPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  galeriaObrazow: Maybe<GaleriaObrazow>;
};
...
/** Input for the deleteGaleriaObrazow mutation. */
export type DeleteGaleriaObrazowInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the galeriaObrazow to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteGaleriaObrazow mutation. */
export type DeleteGaleriaObrazowPayload = {
  __typename?: 'DeleteGaleriaObrazowPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId: Maybe<Scalars['ID']['output']>;
...
/** The &quot;GaleriaGrupa&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type GaleriaGrupa = AcfFieldGroup & AcfFieldGroupFields & GaleriaGrupa_Fields & {
  __typename?: 'GaleriaGrupa';
  /** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;GaleriaGrupa&quot; Field Group */
  dostepnosc: Maybe<Scalars['Boolean']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  /** Kategoria */
  kategoria: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field for storing image details like URL, title, and alt text. */
  obraz: Maybe<AcfMediaItemConnectionEdge>;
  /** Opis grafiki */
  opis: Maybe<Scalars['String']['output']>;
  /** Tytuł grafiki */
  tytul: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;GaleriaGrupa&quot; Field Group */
export type GaleriaGrupa_Fields = {
  /** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;GaleriaGrupa&quot; Field Group */
  dostepnosc: Maybe<Scalars['Boolean']['output']>;
  /**
   * The name of the field group
...
/** The galeriaObrazow type */
export type GaleriaObrazow = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfGaleriaGrupa & {
  __typename?: 'GaleriaObrazow';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors: Maybe<GaleriaObrazowToGaleriaObrazowConnection>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  ...
  /** Connection between the ContentNode type and the EnqueuedStylesheet type */
  enqueuedStylesheets: Maybe<ContentNodeToEnqueuedStylesheetConnection>;
  /** Fields of the GaleriaGrupa ACF Field Group */
  galeriaGrupa: Maybe<GaleriaGrupa>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  galeriaObrazowId: Scalars['Int']['output'];
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid: Maybe<Scalars['String']['output']>;
   ...
   */
  parent: Maybe<GaleriaObrazowToParentConnectionEdge>;
  /** The password for the galeria object. */
  password: Maybe<Scalars['String']['output']>;
  /** Connection between the GaleriaObrazow type and the galeriaObrazow type */
  preview: Maybe<GaleriaObrazowToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId: Maybe<Scalars['ID']['output']>;
...
/** The galeriaObrazow type */
export type GaleriaObrazowAncestorsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The galeriaObrazow type */
export type GaleriaObrazowEnqueuedScriptsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The galeriaObrazow type */
export type GaleriaObrazowEnqueuedStylesheetsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The galeriaObrazow type */
export type GaleriaObrazowTitleArgs = {
  format: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to galeriaObrazow Nodes */
export type GaleriaObrazowConnection = {
  /** A list of edges (relational context) between RootQuery and connected galeriaObrazow Nodes */
  edges: Array<GaleriaObrazowConnectionEdge>;
  /** A list of connected galeriaObrazow Nodes */
  nodes: Array<GaleriaObrazow>;
  /** Information about pagination in a connection. */
  pageInfo: GaleriaObrazowConnectionPageInfo;
};

/** Edge between a Node and a connected galeriaObrazow */
export type GaleriaObrazowConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected galeriaObrazow Node */
  node: GaleriaObrazow;
};

/** Page Info on the connected GaleriaObrazowConnectionEdge */
export type GaleriaObrazowConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum GaleriaObrazowIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the GaleriaObrazow type and the galeriaObrazow type */
export type GaleriaObrazowToGaleriaObrazowConnection = Connection & GaleriaObrazowConnection & {
  __typename?: 'GaleriaObrazowToGaleriaObrazowConnection';
  /** Edges for the GaleriaObrazowToGaleriaObrazowConnection connection */
  edges: Array<GaleriaObrazowToGaleriaObrazowConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<GaleriaObrazow>;
  /** Information about pagination in a connection. */
  pageInfo: GaleriaObrazowToGaleriaObrazowConnectionPageInfo;
};

/** An edge in a connection */
export type GaleriaObrazowToGaleriaObrazowConnectionEdge = Edge & GaleriaObrazowConnectionEdge & {
  __typename?: 'GaleriaObrazowToGaleriaObrazowConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;GaleriaObrazowToGaleriaObrazowConnection&quot; */
export type GaleriaObrazowToGaleriaObrazowConnectionPageInfo = GaleriaObrazowConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'GaleriaObrazowToGaleriaObrazowConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the GaleriaObrazow type and the galeriaObrazow type */
export type GaleriaObrazowToParentConnectionEdge = Edge & GaleriaObrazowConnectionEdge & OneToOneConnection & {
  __typename?: 'GaleriaObrazowToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the GaleriaObrazow type and the galeriaObrazow type */
export type GaleriaObrazowToPreviewConnectionEdge = Edge & GaleriaObrazowConnectionEdge & OneToOneConnection & {
  __typename?: 'GaleriaObrazowToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: GaleriaObrazow;
...
export type MenuItemObjectUnion = Category | GaleriaObrazow | Page | Post | PostFormat | Tag;
...
export type RootMutation = {
  ...
  /** The createGaleriaObrazow mutation */
  createGaleriaObrazow: Maybe<CreateGaleriaObrazowPayload>;
  ...
  /** The deleteGaleriaObrazow mutation */
  deleteGaleriaObrazow: Maybe<DeleteGaleriaObrazowPayload>;
  ...
  /** The updateGaleriaObrazow mutation */
  updateGaleriaObrazow: Maybe<UpdateGaleriaObrazowPayload>;
...
/** The root mutation */
export type RootMutationCreateGaleriaObrazowArgs = {
  input: CreateGaleriaObrazowInput;
};
...
/** The root mutation */
export type RootMutationDeleteGaleriaObrazowArgs = {
  input: DeleteGaleriaObrazowInput;
};
...
/** The root mutation */
export type RootMutationUpdateGaleriaObrazowArgs = {
  input: UpdateGaleriaObrazowInput;
};
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the galeriaObrazow type */
  allGaleriaObrazow: Maybe<RootQueryToGaleriaObrazowConnection>;
  ...
  /** An object of the galeriaObrazow Type.  */
  galeriaObrazow: Maybe<GaleriaObrazow>;
  /**
   * A galeriaObrazow object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  galeriaObrazowBy: Maybe<GaleriaObrazow>;
...
/** The root entry point into the Graph */
export type RootQueryAllGaleriaObrazowArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<RootQueryToGaleriaObrazowConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryGaleriaObrazowArgs = {
  asPreview: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType: InputMaybe<GaleriaObrazowIdType>;
};


/** The root entry point into the Graph */
export type RootQueryGaleriaObrazowByArgs = {
  galeriaObrazowId: InputMaybe<Scalars['Int']['input']>;
  id: InputMaybe<Scalars['ID']['input']>;
  slug: InputMaybe<Scalars['String']['input']>;
...
/** Connection between the RootQuery type and the galeriaObrazow type */
export type RootQueryToGaleriaObrazowConnection = Connection & GaleriaObrazowConnection & {
  __typename?: 'RootQueryToGaleriaObrazowConnection';
  /** Edges for the RootQueryToGaleriaObrazowConnection connection */
  edges: Array<RootQueryToGaleriaObrazowConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<GaleriaObrazow>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToGaleriaObrazowConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToGaleriaObrazowConnectionEdge = Edge & GaleriaObrazowConnectionEdge & {
  __typename?: 'RootQueryToGaleriaObrazowConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: GaleriaObrazow;
...
/** Page Info on the &quot;RootQueryToGaleriaObrazowConnection&quot; */
export type RootQueryToGaleriaObrazowConnectionPageInfo = GaleriaObrazowConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToGaleriaObrazowConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToGaleriaObrazowConnection connection */
export type RootQueryToGaleriaObrazowConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword: InputMaybe<Scalars['Boolean']['input']>;
...
export type SeoContentTypes = {
  ...
  galeriaObrazow: Maybe<SeoContentType>;
...
/** Input for the updateGaleriaObrazow mutation. */
export type UpdateGaleriaObrazowInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date: InputMaybe<Scalars['String']['input']>;
  /** The ID of the galeriaObrazow object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateGaleriaObrazow mutation. */
export type UpdateGaleriaObrazowPayload = {
  __typename?: 'UpdateGaleriaObrazowPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  galeriaObrazow: Maybe<GaleriaObrazow>;
...
/** Provides access to fields of the &quot;GaleriaGrupa&quot; ACF Field Group via the &quot;galeriaGrupa&quot; field */
export type WithAcfGaleriaGrupa = {
  /** Fields of the GaleriaGrupa ACF Field Group */
  galeriaGrupa: Maybe<GaleriaGrupa>;
};
